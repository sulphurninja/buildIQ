              ...
              <CardDescription>
                {product.nickname == 'Unlimited'
                  ...
                  : product.nickname == 'Free' &&
                    "Get a monthly wave of credits to automate your tasks with ease. Perfect for starters looking to dip their toes into buildIQ's automation capabilities."}
              </CardDescription>
              <div className="flex justify-between">
                ...
                <p className="font-bold">
                  {product.nickname == 'Free'
                    ...
                    : product.nickname == 'Pro'
                    ? '5.99'
                    : product.nickname == 'Unlimited' && '199.00'}
                  /mo
                </p>
              </div>
